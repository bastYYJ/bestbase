...
public class PermissionHelper {
    ...
    public void setmPermissionModels(PermissionModel[] mPermissionModels) {
        this.mPermissionModels = mPermissionModels;
    }
     ...
     * @return
     */
    public boolean openApplicationSettings(int requestCode) {
        try {
            Intent intent =
